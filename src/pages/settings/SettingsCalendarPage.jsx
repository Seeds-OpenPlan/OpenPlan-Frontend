...
/*
  SettingsCalendarPage — 연동 (FIX-13~17). 오너 리뷰 3차, item 4: 라운드 2에서
  계정 화면의 한 섹션으로 접었던 것을 다시 독립 하위 화면으로 되돌렸다(오너
  의도 정정 — "계정 바로 옆"은 같은 화면 안이 아니라 리스트에서 인접한 별도
  항목이었다). UI/데이터 자체(CalendarConnectionSection — 구글·애플 단일
  토글 병합)는 라운드 2 그대로 재사용, 이 페이지는 배치만 한다.
